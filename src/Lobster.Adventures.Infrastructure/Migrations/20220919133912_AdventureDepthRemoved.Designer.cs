...
namespace Lobster.Adventures.Infrastructure.Migrations
{
    ...
    [Migration("20220919133912_AdventureDepthRemoved")]
    partial class AdventureDepthRemoved
    {
            ...
            modelBuilder.Entity("Lobster.Adventures.Domain.Entities.Adventure", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            NumberOfNodes = 0,
                            RootNodeId = new Guid("00000000-0000-0000-0000-000000000000")
                        });
                });
            ...
            modelBuilder.Entity("Lobster.Adventures.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDateTime = new DateTime(2022, 9, 19, 14, 39, 11, 493, DateTimeKind.Local).AddTicks(2489),
            ...
            modelBuilder.Entity("Lobster.Adventures.Domain.Entities.UserJourney", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AdventureId = new Guid("35168b83-b5f4-4079-b674-12b5f32e995e"),
                            DateTimeCreated = new DateTime(2022, 9, 19, 13, 39, 11, 493, DateTimeKind.Utc).AddTicks(2751),
                            DateTimeUpdated = new DateTime(2022, 9, 19, 13, 39, 11, 493, DateTimeKind.Utc).AddTicks(2752),
                            Status = 0,
